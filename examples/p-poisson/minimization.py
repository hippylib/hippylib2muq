...
def newtonSolver_ParameterList():
    ...
    parameters["print_level"]           = [0, "print info to screen if set to > 0. Do not print if set to 0"]
    
    return hp.ParameterList(parameters)



class NewtonFwdSolver:
    """
    Newton's method to solve nonlinear forward problems.
